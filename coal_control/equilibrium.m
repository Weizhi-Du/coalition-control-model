...
function [v,u_to] = equilibrium(A,Beta,xeb,Num_region,Gam,col,u_to)
...
% num_ru = size(B_total,2);%number of total efforts  √ª”√…œ
...
v = fmincon(fun,v0,[],[],Aeq,beq,lb,ub,@(v)eqnonlcon(A,Beta,B_total,num_u,Num_region,u_ot,v),options);
